...
pub(crate) unsafe extern "C" fn f1<'a, D: 'a, R: 'static, A0: ConvertArg>(
    this: *mut LibstdCppFnOnce<'a, fn(A0) -> R>,
    a0: A0::Cxx,
) -> R {
    let (data, f) =
...
pub(crate) unsafe extern "C" fn f2<'a, D: 'a, R: 'static, A0: ConvertArg, A1: ConvertArg>(
    this: *mut LibstdCppFnOnce<'a, fn(A0, A1) -> R>,
    a0: A0::Cxx,
    a1: A1::Cxx,
) -> R {
    let (data, f) = unsafe {
...
pub(crate) unsafe extern "C" fn f3<
    ...
    A2: ConvertArg,
>(
    this: *mut LibstdCppFnOnce<'a, fn(A0, A1, A2) -> R>,
    a0: A0::Cxx,
    a1: A1::Cxx,
    a2: A2::Cxx,
) -> R {
...
pub(crate) unsafe extern "C" fn f4<
    ...
    A3: ConvertArg,
>(
    this: *mut LibstdCppFnOnce<'a, fn(A0, A1, A2, A3) -> R>,
    a0: A0::Cxx,
    a1: A1::Cxx,
    a2: A2::Cxx,
    a3: A3::Cxx,
